 ...
 * <p>
 * JDK 22 起 {@link MethodHandleProxies#asInterfaceInstance} 不再基于 {@link Proxy} 实现（改为隐藏类），
 * 因此这里接受任意 {@link MethodHandleProxies#isWrapperInstance wrapper instance}。
 *
 * @author HCL
 * Create at 2021/5/17
 */
public class IdeaProxyLambdaMeta implements LambdaMeta {
    ...
    public IdeaProxyLambdaMeta(Object func) {
